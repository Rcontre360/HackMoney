...
export const About: React.FC = () => {
  return (
    <div
      className={clsx(
        "w-full flex md:flex-row flex-col relative h-full bg-white pt-20 items-center justify-center 2xl:px-32 xl:px-28 sm:px-10 px-6 gap-10"
      )}
    >
...
export const About1: React.FC = () => {
  return (
    <div
      className={clsx(
        "w-full flex md:flex-row flex-col relative h-full bg-white py-20 items-center justify-center 2xl:px-32 xl:px-28 sm:px-10 gap-10"
      )}
    >
      <div className="md:w-1/2 md:text-left text-center">
